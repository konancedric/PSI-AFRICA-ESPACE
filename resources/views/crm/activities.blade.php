...
@section('title', 'Activités CRM - PSI AFRICA')
...
<div class="container-fluid p-4">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            <h2 class="mb-0">📋 Activités CRM</h2>
            <p class="text-muted mb-0">Historique complet de toutes les activités du système CRM</p>
        </div>
        <div>
...
<script>
    ...
    function loadActivities() {
        ...
        console.log('Chargement des activités...', {
            url: `/crm/activities?${params}`,
            params: Object.fromEntries(params)
        });

        fetch(`/crm/activities?${params}`)
            .then(response => {
    ...
    function getActionColor(action) {
        const colors = {
            'Création Client': '#28a745',
            'Modification Client': '#ffc107',
            'Suppression Client': '#dc3545',
            'Création Facture': '#007bff',
            'Modification Facture': '#17a2b8',
            'Suppression Facture': '#dc3545',
            'Paiement': '#28a745',
            'Relance': '#fd7e14',
            'Signature Contrat': '#6f42c1',
            'Paiement Caisse': '#20c997'
        };
