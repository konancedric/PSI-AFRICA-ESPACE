<button type="button" class="btn btn-success btn-sm" data-toggle="modal" data-target="#MEditEtatStatutsEtate{{ $tabStatutsEtat->id }}" title="Editer l'état - {{ $tabStatutsEtat->libelle }}"><i class="fa fa-check-circle"></i></button>
<div class="modal fade" id="MEditEtatStatutsEtate{{ $tabStatutsEtat->id }}" tabindex="-1" role="dialog" aria-labelledby="demoModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content card">
            <div class="modal-header bg-blue text-white text-center">
                <h5 class="modal-title" id="demoModalLabel">Activer le statuts-etat {{ $tabStatutsEtat->libelle }}</h5>
