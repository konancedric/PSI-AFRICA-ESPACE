<button type="button" class="btn btn-success btn-sm" data-toggle="modal" data-target="#MEditEtatGalerieVideoe{{ $tabGalerieVideo->id }}" title="Editer l'état - {{ $tabGalerieVideo->libelle }}"><i class="fa fa-check-circle"></i></button>
<div class="modal fade" id="MEditEtatGalerieVideoe{{ $tabGalerieVideo->id }}" tabindex="-1" role="dialog" aria-labelledby="demoModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content card">
            <div class="modal-header bg-orange text-white text-center">
                <h5 class="modal-title" id="demoModalLabel">Activer la video {{ $tabGalerieVideo->libelle }}</h5>
