<button type="button" class="btn btn-success btn-sm" data-toggle="modal" data-target="#MEditEtatSliderse{{ $tabSliders->id }}" title="Editer l'état - {{ $tabSliders->libelle }}"><i class="fa fa-check-circle"></i></button>
