<form class="forms-sample" method="POST" action="{{url('statuts/create')}}">
    @csrf
    <div class="row">
        ...
        <div class="col-sm-6">
            <div class="form-group">
                <label for="bg_color"><i class="fa fa-magic"></i> {{ __('Couleur')}}<span class="text-red">*</span></label>
        ...
        <div class="col-sm-6">
            <div class="form-group">
                ...
                <input type="number" class="form-control" id="numero_etape" name="numero_etape" placeholder="Numero Etapes" required>
            </div>
        </div>
        <div class="col-sm-6">
            <div class="form-group">
