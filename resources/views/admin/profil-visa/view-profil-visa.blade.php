<button class="btn btn-{{$bgColor}} btn-sm mt-2 mb-2" href="#MFViewProfilVisa{{ $tabProfilVisa->id }}" data-toggle="modal" data-target="#MFViewProfilVisa{{ $tabProfilVisa->id }}" title="Voir {{ $tabProfilVisa->numero_profil_visa }}"><i class="fa fa-eye"></i> Voir le Profil Visa
</button>
