<button type="button" class="btn btn-info btn-sm mt-2 mb-2" data-toggle="modal" data-target="#MEditStatutsEtatProfilVisa{{ $tabProfilVisa->id }}" title="Editer le statuts-etat de la commande {{ $tabProfilVisa->numero_profil_visa }}"><i class="fa fa-magic"></i> Statuts Etat</button>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content card">
            <div class="modal-header bg-blue text-white text-center">
                <h5 class="modal-title" id="demoModalLabel">Editer le statuts-etat de la commande {{ $tabProfilVisa->numero_profil_visa }}</h5>
            ...
            <div class="modal-body text-justify">
                <form class="forms-sample" method="POST" action="{{url('profil-visa/add-statuts-etat')}}">
                    ...
                    <div class="row">
                        ...
                        <input type="hidden" name="numero_profil_visa" value="{{ $tabProfilVisa->numero_profil_visa }}">
                        <div class="col-sm-12">
                        ...
                        <div class="col-sm-12">
                            <div class="form-group">
                                ...
                                <textarea type="text" class="form-control" id="message" name="message" placeholder="message" value="{{ $tabProfilVisa->message }}" required> </textarea>
                            </div>
                        </div>
                        <div class="col-sm-12">
