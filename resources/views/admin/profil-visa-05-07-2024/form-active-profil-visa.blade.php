<button type="button" class="btn btn-success btn-sm" data-toggle="modal" data-target="#MEditEtatProfilVisae{{ $tabProfilVisa->id }}" title="Editer l'état - {{ $tabProfilVisa->objet }}"><i class="fa fa-check-circle"></i></button>
